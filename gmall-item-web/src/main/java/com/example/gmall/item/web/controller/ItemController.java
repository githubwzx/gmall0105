package com.example.gmall.item.web.controller;
...
public class ItemController {
    ...
    @RequestMapping("{skuId}.html")//67 108  并发模拟：同一页面快速访问
    public String item(@PathVariable String skuId, ModelMap map, HttpServletRequest request) throws InterruptedException {
       ...
       //销售属性列表
        ...
        for (PmsSkuInfo skuInfo : pmsSkuInfos) {
            ...
            for (PmsSkuSaleAttrValue pmsSkuSaleAttrValue : skuSaleAttrValueList) {
                k += pmsSkuSaleAttrValue.getSaleAttrValueId() + "|";// "239|245" SaleAttrValueId
            }
